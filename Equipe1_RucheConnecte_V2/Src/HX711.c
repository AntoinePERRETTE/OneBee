...
uint32_t HX_Run(uint32_t tare){
	...
	/**
	 * \brief calibration de la load cell
	 * \details Gestion de la tare pour mettre à 0 le hx711.
	 * \warning Cette fonction peut être a ajusté selon le terrain sur lequel repose la balance
	 */
...
//		}
//		for (uint8_t i = 0; i < 50; i++) {
//			if((calibration[i]>26000) | (calibration[i]< 25000)){
//				tare += 25500;
//			}
//			else{
//				tare += calibration[i];
